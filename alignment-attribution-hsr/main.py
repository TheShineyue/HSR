...
from lib.prune import (
    check_sparsity,
    prune_lvlm_wanda_hf,
    prune_lvlm_wanda_recover_heads_gqa,
)
...
modeltype2path = {
    "llama3-llava-next-8b-hf" : "/home/liyue/model/llama3-llava-next-8b-hf",
}
...
def get_model(model_name, cache_dir="./model_weights", device= None):
    if model_name in [
        ...
        return model
    elif model_name in ['llama3-llava-next-8b-hf']: 
...
def main():
    ...
    if args.sparsity_ratio != 0:
        ...
        if args.prune_method == "lvlm_wanda_recover_heads_gqa":
            prune_lvlm_wanda_recover_heads_gqa(
                args,
                model,
                tokenizer,
                ...
                top_h = args.top_h,
                heads_random_seed = args.heads_random_seed,
